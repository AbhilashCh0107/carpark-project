...
import com.service.parking.theparker.Controller.Activity.StartAdminActivity;
...
//        edit.apply();
        ...
        final String Mobile_code = Theparker.Mobile_code;
        ...
        startPhoneNumberVerification(Mobile_no,Mobile_code);
    ...
    private void startPhoneNumberVerification(String phoneNumber, String mobile_code) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                mobile_code+phoneNumber,        // Phone number to verify
                30,                 // Timeout duration
                        ...
                        FirebaseMessaging.getInstance().getToken()
                                .addOnCompleteListener(new OnCompleteListener<String>() {
                                    ...
                                    public void onComplete(@NonNull Task<String> task) {
                                        ...
                                        UserdataMap.put("device_token", token.trim());
                                        // Log and toast
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (user != null) {
                                        ...
                                        if (user.Role.equalsIgnoreCase("user")){
                                            mainIntent = new Intent(OtpVerifyActivity.this, StartActivity.class);
                                        }else {
                                            mainIntent = new Intent(OtpVerifyActivity.this, StartAdminActivity.class);
                                        }

                                        Pair pair = new Pair<View, String>(mOtp_verify_btn,"loginTransition");
                                        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(OtpVerifyActivity.this, pair);

                                        mainIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                        startActivity(mainIntent,options.toBundle());
                                        finish();
                                        Theparker.animate(OtpVerifyActivity.this);
                                    }
                                }
