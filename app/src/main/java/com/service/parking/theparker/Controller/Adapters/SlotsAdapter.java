...
//            changeColor(slotViewHolder);
        ...
        if (spotsAvailable<=0){
            slotViewHolder.relativeLayout.setBackgroundColor(ContextCompat.getColor(context,R.color.cpb_red_light));
        }else {
            slotViewHolder.relativeLayout.setBackgroundColor(ContextCompat.getColor(context,R.color.cpb_green));
...
//                changeColor(slotViewHolder);
                updateData(slotViewHolder,i,slot.get("slot").toString());
                ...
                Toasty.error(context, "Slot not available", Toast.LENGTH_LONG).show();
            }
        });
...
//            changeColor(slotViewHolder);
    ...
    void updateData(SlotViewHolder slotViewHolder, int i,String slotName) {
        ...
        parkingBooking.setPrice(""+amount);
        parkingBooking.setSlot(slotName);
        parkingBooking.setSlotNumber(slotViewHolder.mNoOfSlots.getText().toString());
