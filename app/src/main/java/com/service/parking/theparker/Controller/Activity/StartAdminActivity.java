...
import com.service.parking.theparker.tenserflow.HomeFragment;

import butterknife.BindView;
import butterknife.ButterKnife;
import de.hdodenhof.circleimageview.CircleImageView;

public class StartAdminActivity extends AppCompatActivity implements HomeFragment.OnFragmentInteractionListener{
    ...
    private final NavigationView.OnNavigationItemSelectedListener mOnNavigationDrawerItemSelectedListener
            = menuItem -> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentUser != null) {
            Glide.with(this).load(mCurrentUser.getPhotoUrl()).placeholder(R.drawable.icon_profile)
                    ...
                    .fallback(R.drawable.icon_profile).into(mProfileImageView);
        }
        mProfileImageView.setOnClickListener(v -> profileActivity());

        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            NetworkServices.ProfileData.setData(mName, mEmail, null, null);
        }
