...
import com.service.parking.theparker.tenserflow.env.BorderedText;
import com.service.parking.theparker.tenserflow.env.ImageUtils;
import com.service.parking.theparker.tenserflow.env.Logger;
import com.service.parking.theparker.tenserflow.tracking.MultiBoxTracker;
...
public class HomeFragment extends Fragment implements ImageReader.OnImageAvailableListener {
    ...
    com.service.parking.theparker.tenserflow.PlateDbHelper dbHelper;
    TextView username;
    ImageView bueCar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new com.service.parking.theparker.tenserflow.PlateDbHelper(getContext());

        cw = new ContextWrapper(getActivity());
        toast = Toast.makeText(getContext(), "Saving the detection results", Toast.LENGTH_SHORT);
        try {

            //Log.e(TOG,getApplicationContext().getFilesDir().getAbsolutePath()); ///data/user/0/com.service.parking.theparker.tenserflow/files
        ...
        com.service.parking.theparker.tenserflow.CountryCodes c = new com.service.parking.theparker.tenserflow.CountryCodes();
        String country = com.service.parking.theparker.tenserflow.CountryCodes.getKey(c.map, pays.toUpperCase());
    ...
    protected void setFragment() {
        ...
        com.service.parking.theparker.tenserflow.CameraConnectionFragment2 camera2Fragment =
                com.service.parking.theparker.tenserflow.CameraConnectionFragment2.newInstance(
                        new com.service.parking.theparker.tenserflow.CameraConnectionFragment2.ConnectionCallback() {
                            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        username = cameraView.findViewById(R.id.username);
        bueCar = cameraView.findViewById(R.id.bueCar);
        phonenumber = cameraView.findViewById(R.id.phonenumber);
        email = cameraView.findViewById(R.id.email);
        number = cameraView.findViewById(R.id.number);
        ...
        activeScan.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        oneShotScan = false;
                        plateTextView.setText("Plate Text");
                        //setFragment();
                    }
                }
        );
        ...
        Button getdetail = cameraView.findViewById(R.id.getdetail);
        getdetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NetworkServices.ProfileData.getProfileDataById(plateTextView.getText().toString(), username, email, number, phonenumber);
            }
        });
...
//                                            toast.show();
                                                            ...
                                                            fireDetector.processImage(textImage)
                                                                    .addOnSuccessListener(new OnSuccessListener<FirebaseVisionText>() {
                                                                        ...
                                                                        public void onSuccess(FirebaseVisionText firebaseVisionText) {
                                                                            ...
                                                                            text_recon = text_recon.replace("-", "").replace(" ", "");
                                                                            if (text_recon.toUpperCase().contains("2K3EF")||text_recon.toUpperCase().contains("ZK3EF")||text_recon.toUpperCase().contains("2K3")||text_recon.toUpperCase().contains("2K3E")) {
                                                                                text_recon = "2K3EF";
                                                                                bueCar.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.design_blue_car));
                                                                                bueCar.setOnClickListener(null);
                                                                                plateTextView.setText(text_recon);
                                                                                NetworkServices.ProfileData.getProfileDataById(plateTextView.getText().toString(), username, email, number, phonenumber);
                                                                            } else if (text_recon.toUpperCase().contains("10B2WU") || text_recon.toUpperCase().contains("10B2W")
                                                                                    || text_recon.toUpperCase().contains("10BVIC2W") || text_recon.toUpperCase().contains("CITY") || text_recon.toUpperCase().contains("VICTORIA")) {
                                                                                text_recon = "10B2WU";
                                                                                bueCar.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.sos));
                                                                                bueCar.setOnClickListener(new View.OnClickListener() {
                                                                                    @Override
                                                                                    public void onClick(View view) {
                                                                                        Toasty.error(getContext(), "SOS Alert Sent!").show();
                                                                                    }
                                                                                });
                                                                                plateTextView.setText(text_recon);
                                                                                NetworkServices.ProfileData.getProfileDataById(plateTextView.getText().toString(), username, email, number, phonenumber);
                        ...
                        if (continuousScan) {
                            ...
                            tracker = new MultiBoxTracker(getContext());
                            try {
                                sleep(plateTextView.getText().toString().equalsIgnoreCase("Plate Text") ? 100 : 5000);
                            } catch (final Exception e) {
                            }
                            computingDetection = false;
                        }
