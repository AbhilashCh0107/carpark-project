...
public abstract class CameraActivity extends Activity
  ...
  protected void setFragment() {
    ...
    Fragment fragment;
    if (useCamera2API) {
      com.service.parking.theparker.tenserflow.CameraConnectionFragment camera2Fragment =
          com.service.parking.theparker.tenserflow.CameraConnectionFragment.newInstance(
              new com.service.parking.theparker.tenserflow.CameraConnectionFragment.ConnectionCallback() {
                @Override
      ...
      fragment =
          new com.service.parking.theparker.tenserflow.LegacyCameraConnectionFragment(this, getLayoutId(), getDesiredPreviewFrameSize());
    }
    getFragmentManager()
        .beginTransaction()
  ...
  public void requestRender() {
    final com.service.parking.theparker.tenserflow.OverlayView overlay = (com.service.parking.theparker.tenserflow.OverlayView) findViewById(R.id.debug_overlay);
    if (overlay != null) {
      overlay.postInvalidate();
    }
  }

  public void addCallback(final com.service.parking.theparker.tenserflow.OverlayView.DrawCallback callback) {
    final com.service.parking.theparker.tenserflow.OverlayView overlay = (com.service.parking.theparker.tenserflow.OverlayView) findViewById(R.id.debug_overlay);
    if (overlay != null) {
